...
{/* <!-- BEGIN Page Wrapper --> */}
            ...
            <div className="page-inner">
                ...
                <aside className="page-sidebar">
                    <div className="page-logo">
                        <a href="#" className="page-logo-link press-scale-down d-flex align-items-center" data-toggle="modal" data-target="#modal-shortcut">
                    ...
                    <nav id="js-primary-nav" className="primary-nav" role="navigation">
                        ...
                        <div className="info-card">
                            ...
                            <a href="#" onclick="return false;" className="pull-trigger-btn" data-action="toggle" data-class="list-filter-active" data-target=".page-sidebar" data-focus="nav_filter_input">
                        ...
                        <ul id="js-nav-menu" className="nav-menu">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="miscellaneous_lightgallery.html" title="Light Gallery" data-filter-tags="miscellaneous light gallery">
                                            ...
                                            <span className="dl-ref label bg-primary-600 ml-2">61 KB</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="page_faq.html" title="FAQ" data-filter-tags="pages faq">
                                            <span className="nav-link-text" data-i18n="nav.pages_faq">FAQ</span>
                                        </a>
                                    </li>
                                    <li>
                ...
                <div className="page-content-wrapper">
                    ...
                    <header className="page-header" role="banner">
                        ...
                        <div className="search">
                            <form className="app-forms hidden-xs-down" role="search" action="search-results.html" autocomplete="off">
                    ...
                    <main id="js-page-content" role="main" className="page-content">
                        <ol className="breadcrumb page-breadcrumb">
                            <li className="breadcrumb-item"><a href="javascript:void(0);">SmartAdmin</a></li>
                            <li className="breadcrumb-item">parent_1</li>
                            <li className="breadcrumb-item">parent_2</li>
                    ...
                    <footer className="page-footer" role="contentinfo">
                        ...
                        <div>
                            <ul className="list-table m-0">
                                <li><a href="#" className="text-secondary fw-700">About</a></li>
                                <li className="pl-3"><a href="#" className="text-secondary fw-700">License</a></li>
                                <li className="pl-3"><a href="#" className="text-secondary fw-700">Documentation</a></li>
                                <li className="pl-3 fs-xl"><a href="#" className="text-secondary"><i className="fal fa-question-circle" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </footer>
                    {/* <!-- END Page Footer -->
                            ...
                            <div className="modal-content">
                                <div className="modal-body">
                                    <ul className="app-list w-auto h-auto p-0 text-left">
                                        ...
                                        <li>
                                            <a href="page_inbox.html" className="app-list-item text-white border-0 m-0">
                                                <div className="icon-stack">
        ...
        {/* <!-- END Page Wrapper -->
        <!-- BEGIN Quick Menu --> */}
        <nav className="shortcut-menu hidden-sm-down">
            ...
            <div className="modal-dialog modal-dialog-right">
                <div className="modal-content h-100">
                    <div className="dropdown-header bg-trans-gradient d-flex align-items-center w-100">
                        <div className="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                            <span className="mr-2">
                                <span className="rounded-circle profile-image d-block" style={{ backgroundImage: "url('img/demo/avatars/avatar-d.png'); background-size: cover;"}}></span>
                            </span>
                            <div className="info-card-text">
                                <a href="javascript:void(0);" className="fs-lg text-truncate text-truncate-lg text-white" data-toggle="dropdown" aria-expanded="false">
                                    Tracey Chang
                        ...
                        <div className="msgr d-flex h-100 flex-column bg-white">
                            ...
                            <div className="d-flex flex-column">
                                ...
                                <div className="height-8 px-3 d-flex flex-row align-items-center flex-wrap flex-shrink-0">
                                    <a href="javascript:void(0);" className="btn btn-icon fs-xl width-1 mr-1" data-toggle="tooltip" data-original-title="More options" data-placement="top">
                                        <i className="fal fa-ellipsis-v-alt color-fusion-300"></i>
                                    </a>
                                    <a href="javascript:void(0);" className="btn btn-icon fs-xl mr-1" data-toggle="tooltip" data-original-title="Attach files" data-placement="top">
                                        <i className="fal fa-paperclip color-fusion-300"></i>
                                    </a>
                                    <a href="javascript:void(0);" className="btn btn-icon fs-xl mr-1" data-toggle="tooltip" data-original-title="Insert photo" data-placement="top">
                                        <i className="fal fa-camera color-fusion-300"></i>
                                    </a>
                                    <div className="ml-auto">
                                        <a href="javascript:void(0);" className="btn btn-info">Send</a>
                                    </div>
                                </div>
                            </div>
                            {/* <!-- END msgr__chatinput --> */}
                    ...
                    <div className="modal-body p-0">
                        <div className="settings-panel">
                            ...
                            <div className="list mt-3">
                                ...
                                <span className="onoffswitch-title-desc d-block mb-g">Change <strong>root</strong> font size to effect rem values</span>
                            </div>
                            <hr className="m-0" />
                            <div className="p-3 d-flex align-items-center justify-content-center bg-faded">
                                <a href="#" className="btn btn-outline-danger fw-500 mr-2" data-action="app-reset">Reset Settings</a>
                                <a href="#" className="btn btn-danger fw-500" data-action="factory-reset">Factory Reset</a>
                            </div>
                        </div>
                        <span id="saving"></span>
                    </div>
